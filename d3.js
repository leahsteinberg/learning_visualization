  ...
  d3.layout.force = function() {
    ...
    force.start = function() {
      ...
      for (i = 0; i < n; ++i) {
        ...
        //console.log(" o is : ", o);
        o.weight = 0;
        //console.log("o weight is: ", o.weight);
      }
      //console.log('****');
      for (i = 0; i < m; ++i) {
        o = links[i];
        //console.log("(links) o is:", 0);
        if (typeof o.source == "number") o.source = nodes[o.source];
        if (typeof o.target == "number") o.target = nodes[o.target];
       // console.log("o.source", o.source, "  o.source.weight: ", o.source.weight);
        //console.log("o.target", o.target, "  o.target.weight: ", o.target.weight);
